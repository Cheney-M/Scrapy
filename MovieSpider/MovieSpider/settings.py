...
DEFAULT_REQUEST_HEADERS = {
    ...
    'keep-alive',
    'Cookie':
    '_ga=GA1.2.1620358295.1551690346; _gid=GA1.2.679830305.1551690346; SL_GWPT_Show_Hide_tmp=1; SL_wptGlobTipTmp=1; __qca=P0-1531339466-1551690349073',
    'DNT':
    '1',
    'Referer':'http://www.hd-trailers.net/',
    'Host':
    'www.hd-trailers.net',
...
ITEM_PIPELINES = {
    'MovieSpider.pipelines.MongoPipline': 300
}
MONGO_URI = 'localhost'
